...
return array(
    ...
    'Speakeasy_API_Reporter' => $baseDir . '/includes/class-api-reporter.php',
    'Speakeasy_Admin_Page' => $baseDir . '/admin/class-admin-page.php',
    'Speakeasy_App_Passwords_Module' => $baseDir . '/modules/app-passwords/class-app-passwords-module.php',
    'Speakeasy_Auto_Updater' => $baseDir . '/includes/class-auto-updater.php',
    'Speakeasy_LAP_Meta_Module' => $baseDir . '/modules/lap-meta/class-lap-meta-module.php',
    'Speakeasy_Module' => $baseDir . '/includes/interface-module.php',
    'Speakeasy_Module_Manager' => $baseDir . '/includes/class-module-manager.php',
